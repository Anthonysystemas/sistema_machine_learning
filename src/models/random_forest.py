...
# Pipeline completo
def run_random_forest_pipeline(X_train, X_test, y_train, y_test):
    ...
    # 2. Evaluar
    results, predictions = evaluate_random_forest(model, X_test, y_test)
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Ejecutar pipeline
        output = run_random_forest_pipeline(X_train, X_test, y_train, y_test)
